...
g=[0,1,1.24, 1.53, 1.82, 2.09, 2.35, 2.6, 2.85, 3.09, 3.33, 3.56, 3.79, 4.01, 4.23, 4.45, 4.66, 4.88, 5.09, 5.30, 5.50, 5.71, 5.92, 6.12, 6.32, 6.52, 6.72, 6.91, 7.12, 7.31, 7.50]  # Associate for each number of hash functions the corresponding average number of increments per insertions. 
...
while(True):
    ...
    l=config_sketch(n_items,alpha,n_cache_slots,thres_av_n_ghosts,g,n_hashes_max)
    ...
    print(" The number of counters: ", n_counters) 
    print(" The number of hash functions: ", n_hashes) 
    ...
    print("The average fraction of non distinguished items in the experiment is: ")
